...
const INTEREST_API_ENABLED_PREF = "interests.navigator.enabled";
...
exports.main = function(options, callbacks) {
  ...
  Services.prefs.getDefaultBranch("").setBoolPref(INTEREST_API_ENABLED_PREF, true);
};
...
exports.onUnload = function(reason) {
  ...
  Services.prefs.getDefaultBranch("").setBoolPref(INTEREST_API_ENABLED_PREF, false);
};
