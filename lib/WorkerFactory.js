...
const sLocaleData = {
  "zh-CN": {
    ...
    serveyEndPoint: "https://www.surveygizmo.com/s3/1545511/firefox-personalization-cn"
  },
  "default": {
    regionCode: "en-US",
    ...
    serveyEndPoint: "https://www.surveygizmo.com/s3/1368483/firefox-personalization"
  },
};
...
WorkerFactory.prototype = {
  ...
  _setupWorker: function(regionCode, modelName) {
    ...
    if (this._localeData.mainTaxonomyModel == modelName) {
  ...
  getSurveyEndPoint: function() {
    return this._localeData.serveyEndPoint;
  },
}
